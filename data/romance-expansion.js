(function () {
  ...
  function buildIntroEvent(definition) {
    ...
    const title = introAge < 16 ? definition.name + "进入了你的校园日常" : definition.name + "开始频繁出现在你的生活里";
    ...
    return event({
      ...
      text:
        ...
        " 你们最开始是因为" +
        firstContext +
        "慢慢有了交集。这样的认识并不一定立刻变成恋爱，但它很可能成为后面很多年关系的起点。",
      minAge: introAge,
      ...
      choices: [
        choice({
          text: "主动和" + definition.name + "熟起来，让这段关系有真正开始的机会。",
          effects: {
          ...
          relationshipEffects: [
            buildEffect(definition.id, {
              ...
              setActive: true,
              history: "你没有把这次相遇留在普通同学层面，而是主动让和" + definition.name + "的联系往前走了一步。"
            })
          ],
          log: definition.name + "开始成为你人生早期会被认真记住的人。"
        }),
        choice({
          text: "先只是默默留意，看看自己会不会越来越在意。",
          effects: {
          ...
          relationshipEffects: [
            buildEffect(definition.id, {
              ...
              setActive: true,
              history: "你先把这份注意藏在心里，但" + definition.name + "已经开始在你的日常里占位置了。"
            })
          ],
          log: "一段早期心动的底色开始形成。"
        }),
        choice({
          text: "先当普通同学相处，不急着给这段关系下定义。",
          effects: {
          ...
          relationshipEffects: [
            buildEffect(definition.id, {
              ...
              status: "noticed",
              addFlags: ["introduced"],
              history: "你们没有一开始就带着太强情绪靠近，但关系的基础被留了下来。"
            })
          ],
  ...
  function buildTheirNoticeEvent(definition) {
    ...
    return event({
      ...
      text: rumorText + " 你慢慢感觉到，这一次不只是你在注意对方，对方也在看你怎么回应。",
      minAge: introAge,
        ...
        choice({
          ...
          relationshipEffects: [
            buildEffect(definition.id, {
              ...
              setActive: true,
              history: "你没有回避" + definition.name + "对你的在意，这让关系第一次真正有了双向感。"
            })
          ],
          log: "有人开始喜欢你这件事，不再只是一种抽象想象。"
        }),
        choice({
          text: "不说破，让暧昧和误会先自己往前长。",
          effects: {
          ...
          relationshipEffects: [
            buildEffect(definition.id, {
              ...
              history: "你没有把话说开，关系因此更像在别人眼神和你们自己的猜测里发酵。"
            })
          ],
          log: "青春期很多关系都不是开始于表白，而是开始于谁都不说明白。"
        }),
        choice({
          text: "先往后退一步，别让大家把事情越说越真。",
          effects: {
          ...
          relationshipEffects: [
            buildEffect(definition.id, {
              ...
              history: "你先把距离拉开了。那份被看见的感觉并没有消失，只是变得有点遗憾。"
            })
          ],
  ...
  function buildWarmupEvent(definition) {
    ...
    const introAge = typeof appearance.minAge === "number" ? appearance.minAge : 18;
    const profile = definition.romanceProfile || {};
    const contextText = pickText(appearance.contexts, "相处");

    return event({
      id: definition.id + "_warmup",
      stage: stageFromAge(Math.max(introAge, 15)),
      title: "你和" + definition.name + "开始越来越熟",
      text:
        "很多关系不是一瞬间定性的，而是在" +
        contextText +
        "里慢慢变得不同。你和" +
        ...
        choice({
          ...
          relationshipEffects: [
            buildEffect(definition.id, {
              ...
              setActive: true,
              history: "你们开始不止是知道彼此，而是真的熟了起来。"
            })
          ],
          log: "熟悉度和信任开始成为这段关系真正的地基。"
        }),
        choice({
          text: "保持有点说不清的暧昧，不急着把界线画死。",
          effects: {
            stats: { happiness: 1, stress: 1 }
          },
          relationshipEffects: [
            buildEffect(definition.id, {
              ...
              history: "你们没有正式定义关系，但很多互动已经开始带着一点暧昧的热度。"
            })
          ],
          log: "有些关系在很长一段时间里，确实只活在‘差一点说开’的状态里。"
        }),
        choice({
          text: "提醒自己先别陷太深，把关系停在可控的位置。",
          effects: {
          ...
          relationshipEffects: [
            buildEffect(definition.id, {
              ...
              history: "你没有切断联系，但明显把关系往更安全的位置收了收。"
            })
          ],
  ...
  function buildConfessionEvent(definition) {
    ...
    return event({
      ...
      text:
        "你们之间已经不是普通同学、普通朋友那样的距离了。问题只剩下一个：要不要把这份喜欢明确说出来。对" +
        definition.name +
        "而言，这条线" +
        arcLabel +
        "。",
        ...
        choice({
          ...
          relationshipEffects: [
            buildEffect(definition.id, {
              ...
              setActive: true,
              history: "你们终于把喜欢说开，关系正式越过了只靠猜测维持的阶段。"
            })
          ],
          log: "这段关系第一次被明确地放到了‘恋爱’的位置上。"
        }),
        choice({
          text: "先不说破，让双向好感继续停留在暧昧里。",
          effects: {
            stats: { happiness: 1, mental: 1 }
          },
          relationshipEffects: [
            buildEffect(definition.id, {
              ...
              history: "你们明明都感觉到了什么，却还是把那层窗户纸留到了以后。"
            })
          ],
        ...
        choice({
          ...
          relationshipEffects: [
            buildEffect(definition.id, {
              ...
              history: "你们不是没机会，只是那次机会最终没有被真正抓住。"
            })
          ],
        ...
        choice({
          ...
          relationshipEffects: [
            buildEffect(definition.id, {
              ...
              setActive: true,
              history: "你们没有直接散开，而是把最难说的话认真说了一遍。"
            })
          ],
        ...
        choice({
          ...
          relationshipEffects: [
            buildEffect(definition.id, {
              ...
              clearActive: true,
              history: "你们没有立刻分手，但关系明显退回到了更远的位置。"
            })
          ],
        ...
        choice({
          ...
          relationshipEffects: [
            buildEffect(definition.id, {
              ...
              clearActive: true,
              history: "你们把分开正式说了出来。这不是一瞬间的选择，而是很多问题积到这里的结果。"
            })
          ],
  ...
  function buildReunionEvent(definition) {
    ...
    return event({
      ...
      text:
        "以前那段关系并没有凭空消失。只是很多年过去以后，你们终于又在一个新的时间点上看见了彼此。问题变成了：这次还要不要重新靠近。",
      minAge,
      maxAge: 45,
      weight: 3,
        ...
        choice({
          ...
          relationshipEffects: [
            buildEffect(definition.id, {
              ...
              setActive: true,
              history: "很多年后，你们重新把彼此放回了人生里。以前没走完的那条线，突然又有了继续的可能。"
            })
          ],
